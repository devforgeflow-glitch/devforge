 ...
 *
 * Exibe os planos disponiveis e permite upgrade.
      ...
      <Layout title={t('nav.pricing')} description={t('pricing.hero.description')}>
              ...
              {['q1', 'q2', 'q3', 'q4'].map((qKey) => (
                <Card key={qKey}>
                  <CardContent className="pt-6">
                    <h3 className="font-semibold mb-2">{t(`pricing.faq.${qKey}.question`)}</h3>
                    <p className="text-muted-foreground">{t(`pricing.faq.${qKey}.answer`)}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container-app text-center">
            <h2 className="heading-2 mb-4">{t('pricing.cta.title')}</h2>
